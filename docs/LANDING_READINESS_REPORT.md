...
| i18n 完整性 | ✅ 1071 个键在中英文资源中完全对齐 |
| 生产构建 | ✅ PWA SW 产出 + precache 130 entries + 边缘网关镜像可复现构建 |
