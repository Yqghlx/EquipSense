...
- [x] **Step 1: Add a fixture helper that writes a valid manifest from existing files**
...
- [x] **Step 2: Add a failing test for a tampered artifact**
...
- [x] **Step 3: Add a failing test for a mixed batch**
...
- [x] **Step 4: Add a failing test for confirm without a manifest**
...
- [x] **Step 5: Run the focused script tests and verify they fail for the missing implementation**
...
- [x] **Step 1: Add a portable SHA-256 helper and validate it before backup execution**

Prefer `sha256sum`, fall back to `shasum -a 256`, and fail with a Chinese message if neither exists.

- [x] **Step 2: Add manifest generation after component backups and before remote sync**
...
- [x] **Step 3: Include manifests in retention cleanup and S3 synchronization**
...
- [x] **Step 4: Add tests for successful manifest and failed manifest prerequisites**
...
- [x] **Step 5: Run the focused script tests and verify they pass**

Run: `bash tests/scripts/production-scripts-test.sh`

Expected: all backup manifest tests and existing backup tests pass.

- [x] **Step 6: Commit the backup implementation**
...
- [x] **Step 1: Add option parsing and usage text**
...
- [x] **Step 2: Implement fixed-field manifest parsing**
...
- [x] **Step 3: Verify every supplied artifact against the manifest**
...
- [x] **Step 4: Gate confirm mode and preserve explicit legacy compatibility**
...
- [x] **Step 5: Run focused restore tests and verify they pass**
...
- [x] **Step 6: Commit the restore implementation**
...
- [x] **Step 1: Pass the generated manifest in the isolated Docker rehearsal**

Fail if the manifest is absent; do not silently fall back to legacy mode.

- [x] **Step 2: Add runbook acceptance and failure-handling steps**
...
- [x] **Step 3: Update risk and readiness evidence**
...
- [x] **Step 1: Run `git diff --check` and confirm no secrets are present**
...
- [x] **Step 2: Run the repository production gates**
...
- [x] **Step 3: Record remaining external blockers honestly**
